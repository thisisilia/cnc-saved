...
// <head>, so it loads and fires BRIDGE_READY early (before the tool's detection
// check times out) and is present in the served HTML source. Runs after
...
const TAG =
  ...
  "onload=\"window.UserLenzBridge&&window.UserLenzBridge.init({source:'userlenz-replay-bridge',allowedOrigins:['*']})\"></script>";
